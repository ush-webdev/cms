<?php
namespace app\modules\dispatcher\catalog\menu\widgets;

use app\modules\dispatcher\catalog\menu\models\MenuItems;
use Yii;
use yii\base\Widget;
use app\modules\dispatcher\catalog\menu\widgets\SideNav;
...
class Menu extends Widget
{
	...
	public function run()
	{
		...
		if (!array_key_exists('heading', $this->options)) {
			$this->options['heading'] = '<span class="glyphicon glyphicon-cog"></span> Menu';
		}
