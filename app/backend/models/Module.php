...
use app\backend\helpers\Data;
use app\backend\behaviors\CacheFlush;
use app\backend\behaviors\SortableModel;

class Module extends \app\backend\components\ActiveRecord
{
    const STATUS_OFF= 0;
    const STATUS_ON = 1;
